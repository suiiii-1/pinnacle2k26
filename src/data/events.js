...
export const events = [
  ...
  },
  {
    ...
    title: 'Title Event',
    category: 'Non Technical',
    description: 'An individual event consisting of 2-3 rounds which will be revealed on spot.',
    teamSize: 'Solo',
    format: '2-3 Rounds (Revealed on spot)',
    formLink: 'https://forms.gle/BJga8C5YUFcvL7GT6',
    rules: [
      'Any form of vulgarity is strictly prohibited.',
      'The winner will be crowned as Mr. / Ms. Pinnacle’26.',
  ...
  },
  {
    ...
    title: 'Cine Quiz',
    category: 'Non Technical',
    description: 'A fun-filled event for movie buffs! Test your knowledge on movies, actors, and directors.',
    teamSize: '2',
    format: 'Trivia / Quiz',
    formLink: 'https://forms.gle/c5wXK5pbKAMeo1J19',
    rules: [
      'Detailed rules are listed in the registration form.',
      'Test your cinematic IQ with your teammate.',
